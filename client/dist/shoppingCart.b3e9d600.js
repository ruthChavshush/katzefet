...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/shoppingCart.js":[function(require,module,exports) {
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
var _excluded = ["quantityInStore"];
...
function addItemToCart(productToAdd) {
  ...
  var product = products.find(function (productInCart) {
    return productInCart.makat === productToAdd.makat;
  });
  if (Number(product.quantityInStore) > 0) {
    existingProduct = shoppingCart.find(function (productInCart) {
      return productInCart.makat === productToAdd.makat;
    });
    product.quantityInStore--;
    var quantityInStore = productToAdd.quantityInStore,
      productDetails = _objectWithoutProperties(productToAdd, _excluded);
    existingProduct ? existingProduct.amount++ : shoppingCart.push(_objectSpread(_objectSpread({}, productDetails), {}, {
      amount: 1
    }));
...
function changeProductAmount(productIndex, changingAmount) {
  var shoppingCart = getShoppingCart();
  var productInCart = shoppingCart[productIndex];
  var products = getProducts();
  var product = products.find(function (p) {
    return p.makat === productInCart.makat;
  });
  if (changingAmount == "1") {
...
function calculateTotal() {
  var shoppingCart = getShoppingCart();
  var total = 0;
  var _iterator = _createForOfIteratorHelper(shoppingCart),
    _step;
  try {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/shoppingCart.js"], null)
//# sourceMappingURL=/shoppingCart.b3e9d600.js.map