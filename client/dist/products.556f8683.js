...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function renderCards(selectedType) {
    container.innerHTML = "";
    shopProducts[selectedType].forEach(function (product) {
  ...
  if (!products) {
    sessionStorage.setItem("products", JSON.stringify([].concat(_toConsumableArray(shopProducts.drinks), _toConsumableArray(shopProducts.iceCream))));
  } else {
