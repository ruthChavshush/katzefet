...
exports.Axios = Axios;
},{"./lib/axios.js":"node_modules/axios/lib/axios.js"}],"js/products.js":[function(require,module,exports) {
"use strict";
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function fetchShopProducts() {
    return _fetchShopProducts.apply(this, arguments);
  }
  function _fetchShopProducts() {
    _fetchShopProducts = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var response, shopProducts;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return _axios.default.get("http://localhost:5000/storeItems");
          case 4:
            response = _context.sent;
            // Update the URL to match your API endpoint
            console.log("response :", response);
            shopProducts = response.data.products; // sessionStorage.setItem("products", JSON.stringify(shopProducts))
            return _context.abrupt("return", shopProducts);
          case 10:
            _context.prev = 10;
            _context.t0 = _context["catch"](0);
            console.log("Error fetching shop products:", _context.t0);
  ...
  function initializeProducts() {
    return _initializeProducts.apply(this, arguments);
  } // Call the function to initialize the product display
  function _initializeProducts() {
    _initializeProducts = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      var products;
